...
"shift-down":function(){return a.multiSelect.moveToNext()},"alt-down":function(){return a.multiSelect.selectLast()},"alt-up":function(){return a.multiSelect.selectFirst()},esc:function(){return a.multiSelect.reset()}};c.bind("keydown",function(b){return a.$apply(function(){var c,l,e,n;e=a.keymap;n=[];for(c in e)l=e[c],d.comboEventMatch(c,b)?(b.preventDefault(),n.push(l.call())):n.push(void 0);return n})});return c.bind("click",function(b){var c;c=angular.element(b.target).scope()[a.selectableName];
return a.$apply(function(){return b.shiftKey?a.multiSelect.includeUntil(c):b.metaKey?c.selected?a.multiSelect.exclude(c,!1):a.multiSelect.include(c,!1):a.multiSelect.reset(c)})})}}};g.$inject=["KeymapUtils","MultiSelect"];angular.module("akop-multi-select").directive("akopMultiSelect",g);angular.module("akop-query-filter",[]);g=function(d,b,a){var c;c=function(a,b,f){var k,e;for(null==f&&(f=[]);a.length;)k=d("filter")(b,a.pop(),!0),f.push(k),c(a,(e=_(b)).without.apply(e,k),f);return _(f).flatten()};
return function(d,h){var f,k,e;h=b(h);e=h.group_by;delete h.group_by;f=a.getArrayArguments(h);k=c(a.arrayArgsToExpressions(h),d);f=0<f.length?c([h],k):c([h],d);if(!e)return f;if(_.any(d,function(a){return void 0===a[e]}))throw Error('serviceQueryFilter: Missing group_by property "'+e+'" for some or all elements in list.');return _.groupBy(f,e)}};g.$inject=["$filter","akopParser","expressionUtils"];angular.module("akop-query-filter").filter("akopQuery",g);angular.module("akop-query-filter").factory("akopParser",
function(){return function(d){var b,a,c,l,h,f,k,e,g;if(d===Object(d)||!(1<d.split(":").length))return d;b=/(\w+):((\w+)|(\[.*\])|"(.*)")/g;for(c=[];a=b.exec(d);)c.push(a);l=function(a){return String(a).replace(/^[\s\"]+|[\s\"]+$/g,"")};d={};e=0;for(g=c.length;e<g;e++)a=c[e],b=a[1],a=a[5]||a[2],(f=a.match(/\[(.*)\]/))?(k=f[1].split(","),d[b]=function(){var a,b,c;c=[];a=0;for(b=k.length;a<b;a++)h=k[a],c.push(""+l(h));return c}()):d[b]=""+a;return d}});g=function(){function d(){}d.prototype.getArrayArguments=
function(b){var a,c;return _.compact(function(){var d;d=[];for(c in b)a=b[c],d.push(_.isArray(a)?{attr:c,arg:a}:void 0);return d}())};d.prototype.arrayArgsToExpressions=function(b){var a,c,d,h,f,k,e,g,m,p;d=[];m=this.getArrayArguments(b);f=0;for(e=m.length;f<e;f++)for(a=m[f],p=a.arg,k=0,g=p.length;k<g;k++)h=p[k],c={},c[a.attr]=h,delete b[a.attr],d.push(c);return d};return d}();angular.module("akop-query-filter").service("expressionUtils",g)}).call(this);
