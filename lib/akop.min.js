...
d>=b;a=c<=b?++d:--d)this.include(this.list[a],!1);else this.reset(b);return this.selected};d.prototype.exclude=function(b,a){var c,d;null==a&&(a=!0);c=this._pos(b);if(a){d=this._is_upper(c);c=this._is_lower(c);if(!d&&!c)return!1;d?(this.selected.pop(),this.cursor=this._upper_index()):(this.selected.splice(this._lower_index(),1,void 0),this.cursor=this._lower_index())}else this.selected.splice(c,1,void 0),this.cursor=this._closest_selected_index(c);b.selected=!1;return this.selected};d.prototype.toggle=
function(b){return b.selected?this.exclude(b,!1):this.include(b,!1)};d.prototype.moveCursorTo=function(b){var a;if(0>b||b>this.list.length-1)return this.selected;a=this.list[b];return a.selected?(a=this._is_desc(b,this.cursor)?1:-1,this.exclude(this.list[b+a])):this.include(a)};d.prototype.selectPrev=function(){return null!=this.cursor===!1||0===this.cursor?this.reset(_.last(this.list)):this.reset(this.list[this.cursor-1])};d.prototype.selectNext=function(){return null!=this.cursor===!1||this.cursor===
this.list.length-1?this.reset(this.list[0]):this.reset(this.list[this.cursor+1])};d.prototype.selectLast=function(){return this.reset(_.last(this.list))};d.prototype.selectFirst=function(){return this.reset(_.first(this.list))};d.prototype.moveToPrev=function(){return this.moveCursorTo(this.cursor-1)};d.prototype.moveToNext=function(){return this.moveCursorTo(this.cursor+1)};d.prototype._closest_selected_index=function(b,a){var c,d,h;null==a&&(a=1);c=b+a;d=b-a;return 0>d&&c>this.list.length-1?!1:
c<=this.list.length-1&&(h=this.list[c],h.selected)?c:0<=d&&(c=this.list[d],c.selected)?d:this._closest_selected_index(b,a+1)};d.prototype._is_asc=function(b,a){return 1===b-a};d.prototype._is_desc=function(b,a){return-1===b-a};d.prototype._pos=function(b){return this.list.indexOf(b)};d.prototype._isAdjacent=function(b){return b-1===this._upper_index()||b+1===this._lower_index()};d.prototype._upper_index=function(){return this.selected.length-1};d.prototype._lower_index=function(){var b;b=_.filter(this.selected,
function(a){return a});return this.selected.indexOf(_.first(b))};d.prototype._is_upper=function(b){return this._upper_index()===b};d.prototype._is_lower=function(b){return this._lower_index()===b};return d}();angular.module("akop-multi-select").factory("MultiSelect",function(){return q});g=function(d,b){return{restrict:"A",link:function(a,c,l){a.$watch(l.akopMultiSelect,function(c){return a.multiSelect=new b(c||[])});a.$watch(l.selectableName,function(){return a.selectableName=l.selectableName});
a.keymap={up:function(){return a.multiSelect.selectPrev()},down:function(){return a.multiSelect.selectNext()},"shift-up":function(){return a.multiSelect.moveToPrev()},"shift-down":function(){return a.multiSelect.moveToNext()},"alt-down":function(){return a.multiSelect.selectLast()},"alt-up":function(){return a.multiSelect.selectFirst()},esc:function(){return a.multiSelect.reset()}};a.multiSelectClickHandler=function(b,c){return b.shiftKey?a.multiSelect.includeUntil(c):b.metaKey?a.multiSelect.toggle(c):
a.multiSelect.reset(c)};c.bind("keydown",function(b){return a.$apply(function(){var e,l,f,n;b.shiftKey&&$(c).addClass("akop-noselect");f=a.keymap;n=[];for(e in f)l=f[e],d.comboEventMatch(e,b)?(b.preventDefault(),n.push(l.call())):n.push(void 0);return n})});c.bind("keyup",function(b){return a.$apply(function(){if(b.shiftKey)return $(c).removeClass("akop-noselect")})});return c.bind("click",function(b){var c;c=angular.element(b.target).scope()[a.selectableName];return a.$apply(function(){return a.multiSelectClickHandler(b,
c)})})}}};g.$inject=["KeymapUtils","MultiSelect"];angular.module("akop-multi-select").directive("akopMultiSelect",g);angular.module("akop-query-filter",[]);g=function(d,b,a){var c;c=function(a,b,e){var k,f;for(null==e&&(e=[]);a.length;)k=d("filter")(b,a.pop(),!0),e.push(k),c(a,(f=_(b)).without.apply(f,k),e);return _(e).flatten()};return function(d,h){var e,k,f;h=b(h);f=h.group_by;delete h.group_by;e=a.getArrayArguments(h);k=c(a.arrayArgsToExpressions(h),d);e=0<e.length?c([h],k):c([h],d);if(!f)return e;
...
l=function(a){return String(a).replace(/^[\s\"]+|[\s\"]+$/g,"")};d={};f=0;for(g=c.length;f<g;f++)a=c[f],b=a[1],a=a[5]||a[2],(e=a.match(/\[(.*)\]/))?(k=e[1].split(","),d[b]=function(){var a,b,c;c=[];a=0;for(b=k.length;a<b;a++)h=k[a],c.push(""+l(h));return c}()):d[b]=""+a;return d}});g=function(){function d(){}d.prototype.getArrayArguments=function(b){var a,c;return _.compact(function(){var d;d=[];for(c in b)a=b[c],d.push(_.isArray(a)?{attr:c,arg:a}:void 0);return d}())};d.prototype.arrayArgsToExpressions=
function(b){var a,c,d,h,e,k,f,g,m,p;d=[];m=this.getArrayArguments(b);e=0;for(f=m.length;e<f;e++)for(a=m[e],p=a.arg,k=0,g=p.length;k<g;k++)h=p[k],c={},c[a.attr]=h,delete b[a.attr],d.push(c);return d};return d}();angular.module("akop-query-filter").service("expressionUtils",g)}).call(this);
