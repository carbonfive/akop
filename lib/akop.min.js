...
grave_accent:192,"{":219,"\\":220,"}":221,"'":222})}]);g=function(d){var a,b,c,f;c=function(a,b,c){null==c&&(c=!0);c||a.sort()&&b.sort();return a.length===b.length&&a.every(function(a,c){return a===b[c]})};f=function(b){var c;c=[];b.altKey&&c.push(a("alt"));b.ctrlKey&&c.push(a("ctrl"));b.shiftKey&&c.push(a("shift"));c.push(parseInt(b.keyCode));return c};a=function(a){return d[a]};b=function(b){return _.map(b.split("-"),function(b){return a(b)})};return{codeFor:a,parseCombo:b,comboEventMatch:function(a,
d){return c(f(d),b(a),!1)}}};g.$inject=["KEYCODES"];angular.module("akop-keymap").service("KeymapUtils",g);angular.module("akop-multi-select",[]);n=function(){function d(a,b){this.list=a;this.root=b;this.moveToNext=k(this.moveToNext,this);this.moveToPrev=k(this.moveToPrev,this);this.selectFirst=k(this.selectFirst,this);this.selectLast=k(this.selectLast,this);this.selectNext=k(this.selectNext,this);this.selectPrev=k(this.selectPrev,this);this.root&&this.reset(this.root)}d.prototype.reset=function(a){this.root=
...
a};return d}();angular.module("akop-multi-select").factory("MultiSelect",function(){return n});g=function(d,a,b){return{restrict:"A",link:function(c,f,e){e=b(e.akopMultiSelect)(c)||{};c.multiSelect=new a(e.items);c.keymap||(c.keymap={});_.extend(c.keymap,e.keymap,{up:function(){return c.multiSelect.selectPrev()},down:function(){return c.multiSelect.selectNext()},"shift-up":function(){return c.multiSelect.moveToPrev()},"shift-down":function(){return c.multiSelect.moveToNext()},"alt-down":function(){return c.multiSelect.selectLast()},
"alt-up":function(){return c.multiSelect.selectFirst()}});return f.bind("keydown",function(a){var b,e,f,h;f=c.keymap;h=[];for(b in f)e=f[b],h.push(c.$apply(function(){if(d.comboEventMatch(b,a))return e.call()}));return h})}}};g.$inject=["KeymapUtils","MultiSelect","$parse"];angular.module("akop-multi-select").directive("akopMultiSelect",g);angular.module("akop-query-filter",[]);g=function(d,a){return function(b,c){var f,e,g,k,l,m,h,n,p,q,s,t,r;c=a(c);h=c.group_by;delete c.group_by;m=[];g=_.compact(function(){var a;
a=[];for(k in c)f=c[k],a.push(_.isArray(f)?{attr:k,arg:f}:void 0);return a}());if(g.length)for(p=0,s=g.length;p<s;p++)for(e=g[p],r=e.arg,q=0,t=r.length;q<t;q++)n=r[q],l={},l[e.attr]=n,delete m[e.attr],m.push(l);e=angular.equals(c,{})?b:(m.push(c),_.flatten(_.reduceRight(m,function(a,c){a.push(d("filter")(b,c,!0));return a},[])));if(!h)return e;if(_.any(b,function(a){return void 0===a[h]}))throw Error('serviceQueryFilter: Missing group_by property "'+h+'" for some or all elements in list.');return _.groupBy(e,
h)}};g.$inject=["$filter","akopParser"];angular.module("akop-query-filter").filter("akopQuery",g);angular.module("akop-query-filter").factory("akopParser",function(){return function(d){var a,b,c,f,e,g;if(d===Object(d)||!(1<d.split(":").length))return d;f=/(\w+):((\w+)|(\[.*\])|"(.*)")/g;for(c=[];b=f.exec(d);)c.push(b);d={};f=0;for(g=c.length;f<g;f++)if(b=c[f],a=b[1],b=b[5]||b[2],e=b.match(/\[(.*)\]/)){b=e[1].split(",");e=d;for(var k=a,l=void 0,m=void 0,h=void 0,h=[],l=0,m=b.length;l<m;l++)a=b[l],
h.push(""+a);e[k]=h}else d[a]=""+b;return d}})}).call(this);
