...
"alt-down":function(){return b.multiSelect.selectLast()},"alt-up":function(){return b.multiSelect.selectFirst()}};return m.bind("keydown",function(a){return b.$apply(function(){var m,f,e,n;e=b.keymap;n=[];for(m in e)f=e[m],c.comboEventMatch(m,a)?(a.preventDefault(),n.push(f.call())):n.push(void 0);return n})})}}};e.$inject=["KeymapUtils","MultiSelect","$parse"];angular.module("akop-multi-select").directive("akopMultiSelect",e);angular.module("akop-query-filter",[]);e=function(c,a,b){var d;d=function(a,
b,h){var e,g;for(null==h&&(h=[]);a.length;)e=c("filter")(b,a.pop(),!0),h.push(e),d(a,(g=_(b)).without.apply(g,e),h);return _(h).flatten()};return function(c,f){var e,l,g;f=a(f);g=f.group_by;delete f.group_by;e=b.getArrayArguments(f);l=d(b.arrayArgsToExpressions(f),c);e=0<e.length?d([f],l):d([f],c);if(!g)return e;if(_.any(c,function(a){return void 0===a[g]}))throw Error('serviceQueryFilter: Missing group_by property "'+g+'" for some or all elements in list.');return _.groupBy(e,g)}};e.$inject=["$filter",
"akopParser","expressionUtils"];angular.module("akop-query-filter").filter("akopQuery",e);angular.module("akop-query-filter").factory("akopParser",function(){return function(c){var a,b,d,e,f,h,l,g,k;if(c===Object(c)||!(1<c.split(":").length))return c;a=/(\w+):((\w+)|(\[.*\])|"(.*)")/g;for(d=[];b=a.exec(c);)d.push(b);e=function(a){return String(a).replace(/^[\s\"]+|[\s\"]+$/g,"")};c={};g=0;for(k=d.length;g<k;g++)b=d[g],a=b[1],b=b[5]||b[2],(h=b.match(/\[(.*)\]/))?(l=h[1].split(","),c[a]=function(){var a,
b,c;c=[];a=0;for(b=l.length;a<b;a++)f=l[a],c.push(""+e(f));return c}()):c[a]=""+b;return c}});e=function(){function c(){}c.prototype.getArrayArguments=function(a){var b,c;return _.compact(function(){var e;e=[];for(c in a)b=a[c],e.push(_.isArray(b)?{attr:c,arg:b}:void 0);return e}())};c.prototype.arrayArgsToExpressions=function(a){var b,c,e,f,h,l,g,k,n,p;e=[];n=this.getArrayArguments(a);h=0;for(g=n.length;h<g;h++)for(b=n[h],p=b.arg,l=0,k=p.length;l<k;l++)f=p[l],c={},c[b.attr]=f,delete a[b.attr],e.push(c);
return e};return c}();angular.module("akop-query-filter").service("expressionUtils",e)}).call(this);
