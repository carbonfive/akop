...
(function() {
  ...
  MultiSelect = (function() {
    ...
    MultiSelect.prototype.reset = function(root) {
      ...
      this.selected = [];
      return this.include(this.root, false);
    };
    ...
    MultiSelect.prototype.exclude = function(el) {
...
(function() {
  ...
  multiSelectDirective = function(KeymapUtils, MultiSelect, $parse) {
    return {
      restrict: 'A',
      link: function($scope, el, attrs) {
        ...
        return el.bind('keydown', function(e) {
