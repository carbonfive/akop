...
(function() {
  var KeymapUtils, MultiSelect, multiSelectDirective, queryFilter, queryParser,
  ...
  queryFilter = function($filter, parse) {
    return function(list, expression) {
      var arg, arg_obj, array_args, attr, exp, expressions, group_by, results, val, _i, _j, _len, _len1, _ref,
        _this = this;
      expression = parse(expression);
      group_by = expression.group_by;
      delete expression.group_by;
      expressions = [];
      array_args = _.compact((function() {
        var _results;
        _results = [];
      ...
      if (array_args.length) {
        for (_i = 0, _len = array_args.length; _i < _len; _i++) {
          arg_obj = array_args[_i];
          _ref = arg_obj.arg;
      ...
      results = angular.equals(expression, {}) ? list : (expressions.push(expression), _.flatten(_.reduceRight(expressions, function(res, exp) {
  ...
  queryParser = function() {
    return function(query) {
      var key, match, matches, obj, pattern, v, val, val_arr, vals, _i, _len;
